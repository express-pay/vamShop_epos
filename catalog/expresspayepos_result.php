...
$epos_code  = MODULE_PAYMENT_EXPRESSPAYEPOS_CODE ."-";
$epos_code  .= "1-";
$epos_code .= $_REQUEST['ExpressPayAccountNumber'];

$qr_code = getQrCode($_REQUEST['ExpressPayInvoiceNo'], MODULE_PAYMENT_EXPRESSPAYEPOS_SECRETWORD, MODULE_PAYMENT_EXPRESSPAYEPOS_TOKEN);
...
$main_content = $vamTemplate->fetch('expresspayepos_result.html');
